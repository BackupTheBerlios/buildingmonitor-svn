<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="AdminProgressRecording.aspx.cs" Inherits="BuildingMonitor.UI.AdminProgressRecordingPage" %>
	...
	<script type="text/javascript">
		...
		function onEndRequest(sender, args) {
			jQuery('#<% Response.Write(pnlContractDetail.ClientID); %> td.bm-progress').each(function(i) {
				bmProgressRecInitSlider(this, true);
			});
